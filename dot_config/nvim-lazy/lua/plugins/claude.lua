return {
  ...
  keys = {
    ...
    { "<leader>aC", "<cmd>ClaudeCodeContinue<cr>", desc = "Claude: continue conversation" },
    { "<leader>aR", "<cmd>ClaudeCodeResume<cr>", desc = "Claude: resume previous session" },
  },
  config = function()
    require("claude-code").setup({
      ...
      window = {
        ...
        float = {
          ...
          border = "double", -- Border style: "none", "single", "double", "rounded", "solid", "shadow"
        },
      },

# Generated by Powerlevel10k configuration wizard on 2025-02-24 at 18:55 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX='%F{#6272a4}╭─'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%F{#6272a4}├─'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%F{#6272a4}╰─'
  # Connect right prompt lines with these symbols.
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_SUFFIX='%F{#6272a4}─╮'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_SUFFIX='%F{#6272a4}─┤'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_SUFFIX='%F{#6272a4}─╯'
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND='#6272a4'           # Comment blue
  # Default current directory foreground color.
  typeset -g POWERLEVEL9K_DIR_FOREGROUND='#f8f8f2'          # Foreground white
  ...
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND='#ffb86c'  # Orange  
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND='#ff5555' # Red
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND='#ff5555' # Red
  typeset -g POWERLEVEL9K_VCS_LOADING_BACKGROUND='#6272a4'   # Comment blue
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND='#50fa7b'     # Green
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND='#bd93f9' # Purple
  ...
  typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND='#6272a4'       # Comment blue
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_BACKGROUND='#8be9fd'    # Cyan
